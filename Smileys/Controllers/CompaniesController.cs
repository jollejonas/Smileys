...
namespace Smileys.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CVR,Name,Address,CurrentSmileyUrl,PreviousSmiley1Url,PreviousSmiley2Urls,PreviousSmiley3Urls")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CVR,Name,Address,CurrentSmileyUrl,PreviousSmiley1Url,PreviousSmiley2Urls,PreviousSmiley3Urls")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
